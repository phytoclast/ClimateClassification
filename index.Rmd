...
The frequency of such cold needs also to be defined. Box (2015) clearly relates vegetation to record cold. However, one time record cold temperature implies that such cold events may or may not occur again within the generation time of any species in question, depending on the length of station record. My preference is instead to use the mean annual extreme low temperature commonly used to delineate hardiness zones. If -15°C is the critical lethal extreme low among a 30 to 100 year station record, it is reasonable to assume that the extreme low for the average year is a few degrees warmer. In North America, only a few broadleaf evergreen trees species occur where annual extreme lows are near -15°C (distributions according to BONAP.org or Little's Tree Atlas -- e.g. Thompson et al, 2015), whereas a significant number of species do occur (including palms) as the temperatures exceed -12 to -10°C. Therefore, it may  be more reasonable to assign the broadleaf-evergreen zone to -10°C instead of -15°C. However, the boundary between deciduous and broadleaf evergreen forest ecoregions in China (Olson et al, 2001) still fits closely to the -15°C annual extreme low temperature boundary (Magarey, Borchert, & Schlegel, 2008). At minimum, it should be recognized that annual extreme lows between -10 and 15°C is a transition zone wherein the potential for broadleaf evergreens increases.

Whether the zone in which broadleaf evergreens prevail should be called "warm-temperate" or "subtropical" is another issue to be resolved. For now, to facilitate the naming of subdivisions within it and adjacent cooler temperate zones, establishing an independent "subtropical" designation was favored. Other systems such as Köppen-Geiger used the term "subtropical" similarly for any warm summer climates with winter cold monthly means from 0 to 18°C. It is acknowledged, however, that the US National Vegetation Classification (Faber-Langendoen et al, 2012) favors "warm-temperate", and the term "subtropical" is used to subdivide a climate with mostly tropical species composition (e.g. Box, 2015).
...
![Figure 7: Map of climatic domains of North America, a broad level synthesis of moisture and temperature regimes.](figures/northamericaclimate_domain20190123s.png)
...
![Figure 8: Map of detailed moisture zonation of North America.](figures/NorthAmerica_MoistureRegime-20190123s.png)
...
![Figure 9: Map of detailed temperature zonation of North America.](figures/northamericaclimate_biotemperature20181002s.png)
    ...
    * 2a. Tg ≥ 18°C
        * 3a. Tc ≥ 15°C and Tclx ≥ 0°C  ... **Tropical**
            * Annual P/PET ratio ≥ 1 and total monthly deficit < 150 mm
                * Tg ≥ 24  ...   **715 Hot Tropical Isopluvial Humid -- Tropical Lowland Moist Forest**
                * Tg < 24  ...   **714 Warm Tropical Isopluvial Humid -- Tropical Premontane Moist Forest**
...
![Figure 10: Map of general climate of North America, an intermediate level synthesis of moisture and temperature regimes.](figures/NorthAmerica_GeneralClimate-20190305s.png)

![Figure 11: Map of general climate of CONUS, an intermediate level synthesis of moisture and temperature regimes.](figures/CONUS_GeneralClimate-20190305s.png)
...
####Climate maps derived from these raster GIS data sources: 
