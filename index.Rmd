...
Winter for a plant is when temperatures are less than optimal for continued activity or exceeds the limits of cold tolerance for exposed tissues. Coldest mean monthly temperature and annual extreme low are highly correlated winter season parameters with contrasting effects on vegetation. Mean temperatures of the coldest month determines the cumulative potential for continued photosynthesis as opposed to dormancy. It can also indicate other effects such as whether soil is likely to be freeze, leaving an evergreen more vulnerable to desiccation. Extreme low temperature is more direct, causing mortality to tissues that are not adapted. Due unequal distribution of continental landmasses, plants in the northern hemisphere are more likely to be limited by extreme temperatures at mean temperatures suitable for photosynthesis. Conversely, plants in the southern hemisphere and on oceanic islands are more likely reach a sublethal seasonal cold temperature limitation related to productivity.

 Plants optimized for photosynthesis at higher temperatures often lack the necessary protection for leaf tissues to tolerate low temperatures as such protections are not worth the loss of productivity. Conversely, plants that are not able to benefit a distinct seasonal peak in productivity must persist and maintain readiness at lower rates.
