    ...
    * 2a. Tg ≥ 18°C
        ...
        * 3b. Tc < 15°C or Tclx < 0°C ... **Subtropical**
            ...
            * Annual P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * Annual P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm
                    * Peak AET ≥ 75 mm.
                        * Annual P/PET ratio ≥ 1 ...   **621 Subtropical Pluviothermic Humid -- Subtropical Seasonal Woodland/Savanna**
                        * Annual P/PET ratio < 1 ...   **611 Subtropical Pluviothermic Subhumid -- Subtropical Grassland/Prairie/Subtropical Xeric Woodland**
                    * Peak AET < 75 mm.
        ...
        * Annual P/PET ratio < 1 or total monthly deficit ≥ 150 mm
            * Annual P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm
                * Peak AET ≥ 75 mm.
                    ...
                    * Annual P/PET ratio < 1 ...   **311 Temperate Pluviothermic Subhumid -- Temperate Grassland/Temperate Deciduous Xeric Woodland**
                * Peak AET < 75 mm.
                    * Annual P/PET ratio ≥ 1 ...   **320 Temperate Xerothermic Humid -- Temperate Dry Evergreen Forest/Temperate Evergreen Xeric Woodland**
...
![Figure 12: Map of general climate of CONUS, a synthesis of moisture and temperature regimes.](figures/CONUS_GeneralClimate-20190430.png)

![Figure 13: Map of general climate of the world, a synthesis of moisture and temperature regimes.](figures/GLOBAL_GeneralClimate-20190605.png)
...
![Figure 13: Example of of vegetation model using climate and soil indices.](figures/NorthAmerica_Vegetation-20190601.png)
...
***
####Click for [Alternative General Climate Map Legend](./altclimate.html)

####Click for [Vegetation Analysis](./vegetation.html)
...
####Relationship of NPP to AET: 

Ito, A. and Inatomi, M., 2012. Water-use efficiency of the terrestrial biosphere: a model analysis focusing on interactions between the global carbon and water cycles. Journal of Hydrometeorology, 13(2), pp.681-694.

***
###Appendix: Climate Browsers

***
The **MLRA Climate Browser** (https://usda.shinyapps.io/MLRAClimate/) allows a user to compare climates of up to two different MLRAs at a time for various climatic parameters. The default monthly temperature and precipitation graph shows the relationship of precipitation with potential evapotranspiration. Both precipitation and temperature include error bars indicating the lowest and highest 6 out of 30-year record (20th and 80th percentiles) among the stations within the MLRA (shows both temporal and geographic variability). Other graphs show individual station means for each parameter.

The **Station Climate Browser** (https://usda.shinyapps.io/StationClimR/) allows a user to compare climates of up to two different United States climate stations at a time for various climatic parameters. The default monthly temperature and precipitation graph shows the relationship of precipitation with potential evapotranspiration. Both precipitation and temperature include error bars indicating the lowest and highest 6 out of 30-year record (20th and 80th percentiles) within a single station. Other graphs show individual record year for each parameter.
