...
In North America, only a few broadleaf evergreen trees species occur where annual extreme lows are near -15°C (distributions according to BONAP.org or Little's Tree Atlas -- e.g. Thompson et al, 2015), whereas a significant number of species do occur (including palms) as the temperatures exceed -12 to -10°C. Therefore, it may  be more reasonable to assign the broadleaf-evergreen zone to -10°C instead of -15°C, especially since the original emphasis was on rarer, less than annual, record extreme low temperature events. However, the boundary between deciduous and broadleaf evergreen forest ecoregions in China (Olson et al, 2001) still fits closely to the -15°C annual extreme low temperature boundary (Magarey, Borchert, & Schlegel, 2008). At minimum, it should be recognized that annual extreme lows between -10 and 15°C is a transition zone wherein the potential for broadleaf evergreens increases.
