...
Vegetation zonation at warmer temperatures should also be expected to follow a growing season optimum according to each species, except where critical thresholds of cold or drought tolerances are exceeded. Examples can be seen where crops and tree genera associated with the temperate zone are found in the premontane and montane zones of tropical mountains where warm seasons are comparable, but winters are very different. The limits to most crops and the boundary between the temperate deciduous and boreal forest zones corresponds roughy to a growing season temperature of 12°C.

![Relationship of temperature with elevation showing the potential elevation of the timberline 6°C in the southern Appalachian would be almost 1000m above the highest peaks, and therefore unrelated to the the presence of balds on some peaks. Also shows that winter cold never reaches the winter cold limitation of any tree species before it runs out of summer warmth](figures/TemperatureElevation.png)

**Annual Extreme Low/Coldest Mean Monthly Temperature**

Winter for a plant is when temperatures are less than optimal for continued activity or exceeds the limits of cold tolerance for exposed tissues. Coldest mean monthly and annual extreme low temperatures are correlated winter season parameters with contrasting effects on vegetation. Mean temperatures of the coldest month determines the potential for photosynthesis versus the need for dormancy. It can also indicate other effects such as whether soil is likely to be frozen, leaving an evergreen more vulnerable to desiccation. Extreme low temperature is more direct, causing mortality to tissues that are not adapted. Plants in the northern hemisphere are more likely to be limited by extreme temperatures even while mean monthly temperatures might still be suitable for photosynthesis. In setting up a winter hardiness zones, most emphasis is placed on the extremes. But some consideration is needed to put limits on mean monthly temperatures where extreme temperatures do not correspond.
The synthesis of extreme cold and average cold into a single index was made to accommodate the concept of subtropical as a climate warm enough to maintain year-round photosynthesis, but subject to frost. The modal vegetation difference between temperate (continental) and subtropical and tropical vegetation is the presence of broadleaf evergreen species and palms. According to Prentice et al, (1992) and Box (1996), most frost tolerate broadleaf evergreens are hardy to extreme low temperatures of -15°C. Most tropical species lack any adaptation to cold and can sustain tissue damage at temperatures as high as 5°C, whereas others can withstand lows of -2°C. The Köppen-Geiger system delineates subtropical and oceanic climate zones where mean temperature of the coldest month exceeds 0°C, and a tropical climate zone where temperature exceeds 18°C. The Holdridge system does not address seasonality, but uses annual biotemperature of 18°C and 24°C for subtropical and tropical zones respectively.


The cold index used here for a subtropical designation, therefore, pivots around whichever is above the more limiting value relative to 0°C for coldest mean monthly and -15°C annual extreme low temperatures. Tropical climate is defined here to be frost free above the 0°C extreme low temperature threshold and allowing a coldest monthly mean temperature to be as low as 15°C, maintaining the 15-degree differential between the two parameters. The consensus among different systems maintaining subtropical or tropical climates above an 18°C threshold will be expressed by setting it as the lower limit of growing season temperature, below which an oceanic or tropical montane climate will be defined.
The cold index can be tuned further to subdivide the temperate (continental) climates. While most of the zonation will pivot on limitations to growing season warmth, there are some limits on groups of taxa. The hardiness of boreal species tends to be almost unlimited, whereas most temperate deciduous genera persist only down to -40°C. The diversity of temperate deciduous species drops sharply where annual extreme lows fall below -25°C.

![Comparision between a ajacent temperate zone climates (MLRA 98A and MLRA 94A) that support different zonal vegetation based on temperature differences.](figures/TemperatureCompare.png)
...
![Comparision between a humid isopluvial climate (MLRA 98A) and a perhumid xerothermic climate (MLRA 1), showing that significant moisture stress can be more likely in the wetter climate if soil water holding capacity is less than the total moisture deficit.](figures/MoistureDroughtCompare.png)
...
![Comparision between a subtropical prairie climate (MLRA 78A) and a chapparal climate (MLRA 14), showing how peak AET is the key difference.](figures/pAET_Compare.png)
...
![Map of climatic domains of North America, a broad level synthesis of moisture and temperature regimes.](figures/northamericaclimate_domain20190123s.png)
...
![Map of detailed moisture zonation of North America.](figures/NorthAmerica_MoistureRegime-20190123s.png)
...
![Map of detailed temperature zonation of North America.](figures/northamericaclimate_biotemperature20181002s.png)

###Possible Map Legend
* 1a. Tc ≥ 0°C and Tclx ≥ -15°C
    * 2a. Tg ≥ 18°C
        * 3a. Tc ≥ 15°C and Tclx ≥ 0°C  ... **Tropical**
            * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
                * Tg ≥ 24 and Tc ≥ 20° C and Tclx > 5°C  ...   **Tropical Isopluvial Humid Lowland**
                * Tg < 24 or Tc < 20° C or Tclx < 5°C  ...   **Tropical Isopluvial Humid Premontane**
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * P/PET ratio ≥ 1 ...   **Tropical Pluviothermic Humid**
                    * P/PET ratio < 1 ...   **Tropical Pluviothermic Subhumid**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **Tropical Isoxeric**
        * 3b. Tc < 15°C or Tclx < 0°C ... Subtropical
            * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
                * Tc ≥ 5° C and Tclx ≥ -10°C  ...   **Eusubtropical Isopluvial Humid**
                * Tc < 5° C or Tclx < -10°C  ...   **Cryosubtropical Isopluvial Humid**
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * Peak AET ≥ 75 mm.
                        * P/PET ratio ≥ 1 ...   **Subtropical Pluviothermic Humid**
                        * P/PET ratio < 1 ...   **Subtropical Pluviothermic Subhumid**
                    * Peak AET < 75 mm.
                        * P/PET ratio ≥ 1 ...   **Subtropical Xerothermic Humid**
                        * P/PET ratio < 1 ...   **Subtropical Xerothermic Subhumid**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **Subtropical Isoxeric**
    * 2b. Tg < 18°C
        * 4a. Tg ≥ 6°C  ...  **Oceanic**
            * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
                * Tg ≥ 12°C  ...   **Mild Oceanic Isopluvial Humid**
                * Tg < 12°C  ...   **Cool Oceanic Isopluvial Humid**
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * Peak AET ≥ 75 mm.
                        * P/PET ratio ≥ 1 ...   **Oceanic Pluviothermic Humid**
                        * P/PET ratio < 1 ...   **Oceanic Pluviothermic Subhumid**
                    * Peak AET < 75 mm.
                        * P/PET ratio ≥ 1 ...   **Oceanic Xerothermic Humid**
                        * P/PET ratio < 1 ...   **Oceanic Xerothermic Subhumid**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **Oceanic Isoxeric**

        * 4b. Tg < 6°C  ...  **Andean**
            * P/PET ratio ≥ 1  ...  **Andean Humid**
            * P/PET ratio ≥ 1  ...  **Andean Subhumid**
* 1b. Tc ≥ 0° C or Tclx < -15°C
    * 5a. Tg ≥ 12°C  ...  **Temperate**
        * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
            * Tg ≥ 18°C and Tc ≥ -10° C and Tclx ≥ -25°C  ...   **Warm Thermotemperate Isopluvial Humid**
            * Tg < 18°C or Tc ≥ -10° C or Tclx > -25°C
                * Tg ≥ 15°C and Tc ≥ -25° C or Tclx > -40°C  ...   **Mild Mesotemperate Isopluvial Humid**
                * Tg < 15°C or Tc < -25° C or Tclx < -40°C  ...   **Mild Cryotemperate Isopluvial Humid**
        * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
            * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                * Peak AET ≥ 75 mm.
                    * P/PET ratio ≥ 1 ...   **Temperate Pluviothermic Humid**
                    * P/PET ratio < 1 ...   **Temperate Pluviothermic Subhumid**
                * Peak AET < 75 mm.
                    * P/PET ratio ≥ 1 ...   **Temperate Xerothermic Humid**
                    * P/PET ratio < 1 ...   **Temperate Xerothermic Subhumid**
            * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **Temperate Isoxeric**

    * 5b. Tg < 12°C
        * 6a. Tg ≥ 6°C  ...  **Boreal**
            * P/PET ratio ≥ 1  ...  **Boreal Humid**
            * P/PET ratio ≥ 1  ...  **Boreal Subhumid**
        * 6b. Tg < 6°C  ...  **Arctic**
            * P/PET ratio ≥ 1  ...  **Arctic Humid**
            * P/PET ratio ≥ 1  ...  **Arctic Subhumid**
...
![A map shows the extent of the stations used in the climate summary.](figures/Map_98A.png)
