...
```
##A Climate Classification Outline Using Biologically Meaningful Indices for Modeling Plant Distributions
        ...
        * 3a. Tc ≥ 15°C and Tclx ≥ 0°C  ... **Tropical**
            ...
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * P/PET ratio ≥ 1 ...   **712-713 Tropical Pluviothermic Humid -- Tropical Seasonal/Monsoon Forest**
                    * P/PET ratio < 1 ...   **702-703 Tropical Pluviothermic Subhumid -- Tropical Dry Forest/Savanna**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **701 Tropical Isoxeric -- Tropical Desert**
        * 3b. Tc < 15°C or Tclx < 0°C ... **Subtropical**
            * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
            ...
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * Peak AET ≥ 75 mm.
                        * P/PET ratio ≥ 1 ...   **613 Subtropical Pluviothermic Humid -- Subtropical Woodland/Savanna**
                        * P/PET ratio < 1 ...   **603 Subtropical Pluviothermic Subhumid -- Subtropical Grassland**
                    * Peak AET < 75 mm.
                        * P/PET ratio ≥ 1 ...   **612 Subtropical Xerothermic Humid -- Subtropical Sclerophyllous Forest**
                        * P/PET ratio < 1 ...   **602 Subtropical Xerothermic Subhumid -- Subtropical Sclerophyllous Shrubland**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **Subtropical Isoxeric -- Subtropical Desert**
    * 2b. Tg < 18°C
        * 4a. Tg ≥ 6°C  ...  **Oceanic**
            * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
            ...
            * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
                * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                    * Peak AET ≥ 75 mm.
                        * P/PET ratio ≥ 1 ...   **513 Oceanic Pluviothermic Humid -- Subtropical Montane Seasonal Forest**
                        * P/PET ratio < 1 ...   **503 Oceanic Pluviothermic Subhumid -- Subtropical Montane Seasonal Woodland**
                    * Peak AET < 75 mm.
                        * P/PET ratio ≥ 1 ...   **512 Oceanic Xerothermic Humid -- Oceanic Sclerophyllous Forest**
                        * P/PET ratio < 1 ...   **502 Oceanic Xerothermic Subhumid -- Oceanic Sclerophyllous Shrubland**
                * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **601 Oceanic Isoxeric -- Oceanic Desert**

        * 4b. Tg < 6°C  ...  **Andean**
            * P/PET ratio ≥ 1  ...  **412-415 Andean Humid -- Paramos**
            * P/PET ratio ≥ 1  ...  **401-402 Andean Subhumid -- Puna**
* 1b. Tc ≥ 0° C or Tclx < -15°C
    * 5a. Tg ≥ 12°C  ...  **Temperate**
        * P/PET ratio ≥ 1 and total monthly deficit < 150 mm
            * Tg ≥ 18°C and Tc ≥ -10° C and Tclx ≥ -25°C  ...   **316 Warm Thermotemperate Isopluvial Humid -- Warm Temperate Deciduous Forest**
            * Tg < 18°C or Tc ≥ -10° C or Tclx > -25°C
                * Tg ≥ 15°C and Tc ≥ -25° C or Tclx > -40°C  ...   **315 Mild Mesotemperate Isopluvial Humid -- Mild Temperate Deciduous/Mixed Forest**
                * Tg < 15°C or Tc < -25° C or Tclx < -40°C  ...   **314 Mild Cryotemperate Isopluvial Humid -- Hemiboreal Mixed Forest**
        * P/PET ratio < 1 or total monthly deficit ≥ 150 mm
            * P/PET ratio ≥ 0.5 or total monthly surplus ≥ 25 mm or peak AET ≥ 75 mm
                * Peak AET ≥ 75 mm.
                    * P/PET ratio ≥ 1 ...   **313 Temperate Pluviothermic Humid -- Temperate Woodland/Savanna**
                    * P/PET ratio < 1 ...   **303 Temperate Pluviothermic Subhumid -- Temperate Grassland**
                * Peak AET < 75 mm.
                    * P/PET ratio ≥ 1 ...   **312 Temperate Xerothermic Humid -- Temperate Dry Evergreen Forest**
                    * P/PET ratio < 1 ...   **302 Temperate Xerothermic Subhumid -- Temperate Steppe**
            * P/PET ratio < 0.5 and total monthly surplus < 25 mm and peak AET < 75 mm   ...   **301 Temperate Isoxeric -- Temperate Desert**

    * 5b. Tg < 12°C
        * 6a. Tg ≥ 6°C  ...  **Boreal**
            * P/PET ratio ≥ 1  ...  **212-214 Boreal Humid -- Boreal Forest**
            * P/PET ratio ≥ 1  ...  **201-203 Boreal Subhumid -- Cool Shrubland**
        * 6b. Tg < 6°C  ...  **Arctic**
            * P/PET ratio ≥ 1  ...  **112-114 Arctic Humid -- Wet Tundra**
            * P/PET ratio ≥ 1  ...  **101-103 Arctic Subhumid -- Dry Tundra**
